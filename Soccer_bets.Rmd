...
leagues_available_moj <- c("Germany Bundesliga","France Ligue 2")
leagues_available_fte <- c("German Bundesliga", "French Ligue 2")
...
ggplot(aes(x = Prob_in_decimal, y = decimal))+
  geom_point() +
  geom_abline(slope = 1) +
  geom_label_repel(aes(label = Name_for_graph, col = League), size = 2.3) +
